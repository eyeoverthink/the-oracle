...
class PassiveLearningSystem:
    ...
    def integrate_with_knowledge_base(self, knowledge_base, source_name="physics"):
        ...
        for category, concepts in knowledge_base.get('concepts', {}).items():
            ...
            for concept in concepts[:10]:  # Limit to 10 concepts per category to avoid overload
        ...
        for equation in knowledge_base.get('equations', [])[:20]:  # Limit to 20 equations
        ...
        for theory in knowledge_base.get('theories', [])[:15]:  # Limit to 15 theories
